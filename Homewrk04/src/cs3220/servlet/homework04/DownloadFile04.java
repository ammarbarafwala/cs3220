...
/**
 * Servlet implementation class DownloadFile04
 */
@WebServlet("/DownloadFile04")
public class DownloadFile04 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        cs3220.servlet.homework04.model.File currentFile=map.get(parentFolderId).get(currentFolderId);
